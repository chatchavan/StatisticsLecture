...
Since we just scaled Gosset's statistics by a constant $\sqrt{n}$, the resulting distribution still follows the shape of the t-distribution as shown below.
