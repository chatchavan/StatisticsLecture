...
wilcox_result_t <- bind_rows(
  tidy(wilcox.test(err_B, err_A, paired = TRUE, conf.int = TRUE, conf.level = my_conf)),
  tidy(wilcox.test(err_C, err_A, paired = TRUE, conf.int = TRUE, conf.level = my_conf)),
  tidy(wilcox.test(err_C, err_B, paired = TRUE, conf.int = TRUE, conf.level = my_conf))
)
